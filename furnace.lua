...
local function has_locked_furnace_privilege(pos, player)
...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		swap_node(pos, "citadella:furnace_active")
		...
		swap_node(pos, "citadella:furnace")
...
minetest.register_node("citadella:furnace", {
	description = "Furnace",
	tiles = {
	...
	on_blast = function(pos)
		...
		drops[#drops+1] = "citadella:furnace"
...
minetest.register_node("citadella:furnace_active", {
	description = "Furnace",
	tiles = {
		"default_furnace_top.png", "default_furnace_bottom.png",
		"default_furnace_side.png", "default_furnace_side.png",
